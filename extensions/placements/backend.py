...
POURQUOI DEUX ROUTEURS. Les titres (`/actions`) et les portefeuilles
(`/placements`) sont deux ressources distinctes — un titre existe
indépendamment des comptes qui le détiennent — et ils étaient déjà séparés
quand cette fonctionnalité vivait dans le noyau. Les fondre en un seul aurait
été un remaniement gratuit, sans rapport avec le passage en extension.
